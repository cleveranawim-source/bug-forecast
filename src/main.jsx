...
const DISTRICT_PLACES = {
  gangseo: [
    ...
    { name: '우장산·봉제산', act: '🚶 산책', env: 'mountain' },
    { name: '서울식물원', act: '👶 나들이', env: 'urban' },
  ],
  yangcheon: [
    { name: '안양천 산책로', act: '🚴 라이딩·러닝', env: 'riverside' },
    { name: '용왕산·계남공원', act: '🚶 산책', env: 'mountain' },
    { name: '서서울호수공원', act: '👶 나들이', env: 'urban' },
    { name: '파리공원·오목공원', act: '🚶 산책', env: 'urban' },
  ],
  guro: [
  ...
  yeongdeungpo: [
    ...
    { name: '안양천 합류·양평', act: '🚴 라이딩', env: 'riverside' },
  ...
  seocho: [
    { name: '반포·잠원 한강공원', act: '🚴 라이딩·러닝', env: 'riverside' },
    { name: '양재천 산책로', act: '🚴 라이딩·러닝', env: 'riverside' },
    { name: '우면산·서리풀공원', act: '🚶 산책', env: 'mountain' },
  ...
  songpa: [
    ...
    { name: '성내천·탄천', act: '🚴 라이딩·산책', env: 'riverside' },
  ...
  mapo: [
    { name: '망원·난지 한강공원', act: '🚴 라이딩·러닝', env: 'riverside' },
    { name: '월드컵공원·하늘공원', act: '👶 나들이', env: 'urban' },
    { name: '경의선숲길', act: '🚶 산책·러닝', env: 'urban' },
    { name: '불광천 합류', act: '🚴 라이딩', env: 'riverside' },
  ],
  eunpyeong: [
  ...
  dobong: [
    { name: '중랑천 자전거길', act: '🚴 라이딩·러닝', env: 'riverside' },
    { name: '도봉산·초안산', act: '🚶 산책', env: 'mountain' },
