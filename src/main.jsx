...
const DISTRICT_DONGS = {
  ...
  dongducheon: ['생연1동', '생연2동', '중앙동', '보산동', '불현동', '송내동', '소요동', '상패동'],
  yangju: ['백석읍', '은현면', '남면', '광적면', '장흥면', '양주1동', '양주2동', '회천1동', '회천2동', '회천3동', '옥정1동', '옥정2동'],
  paju: ['문산읍', '파주읍', '법원읍', '조리읍', '월롱면', '탄현면', '광탄면', '파평면', '적성면', '장단면', '금촌1동', '금촌2동', '금촌3동', '교하동', '운정1동', '운정2동', '운정3동', '운정4동', '운정5동', '운정6동'],
  uijeongbu: ['의정부1동', '의정부2동', '호원1동', '호원2동', '장암동', '신곡1동', '신곡2동', '송산1동', '송산2동', '송산3동', '자금동', '가능동', '흥선동', '녹양동', '고산동'],
  namyangju: ['와부읍', '진접읍', '화도읍', '진건읍', '오남읍', '퇴계원읍', '별내면', '수동면', '조안면', '호평동', '평내동', '금곡동', '양정동', '다산1동', '다산2동', '별내동'],
  guri: ['갈매동', '동구동', '인창동', '교문1동', '교문2동', '수택1동', '수택2동', '수택3동'],
  yangpyeong: ['양평읍', '강상면', '강하면', '양서면', '옥천면', '서종면', '단월면', '청운면', '양동면', '지평면', '용문면', '개군면'],
  yeoju: ['가남읍', '점동면', '흥천면', '금사면', '세종대왕면', '대신면', '북내면', '강천면', '산북면', '여흥동', '중앙동', '오학동'],
  gwangju_gg: ['초월읍', '곤지암읍', '도척면', '퇴촌면', '남종면', '남한산성면', '경안동', '송정동', '쌍령동', '탄벌동', '광남1동', '광남2동', '오포1동', '오포2동', '신현동', '능평동'],
  icheon: ['장호원읍', '부발읍', '신둔면', '백사면', '호법면', '마장면', '대월면', '모가면', '설성면', '율면', '창전동', '증포동', '중리동', '관고동'],
  hanam: ['천현동', '신장1동', '신장2동', '덕풍1동', '덕풍2동', '덕풍3동', '감북동', '감일동', '위례동', '춘궁동', '초이동', '미사1동', '미사2동', '미사3동'],
  seongnam: ['신흥1동', '신흥2동', '신흥3동', '태평1동', '태평2동', '태평3동', '태평4동', '수진1동', '수진2동', '단대동', '산성동', '양지동', '복정동', '위례동', '신촌동', '고등동', '시흥동', '성남동', '중앙동', '금광1동', '금광2동', '은행1동', '은행2동', '상대원1동', '상대원2동', '상대원3동', '하대원동', '도촌동', '분당동', '수내1동', '수내2동', '수내3동', '정자동', '정자1동', '정자2동', '정자3동', '서현1동', '서현2동', '이매1동', '이매2동', '야탑1동', '야탑2동', '야탑3동', '판교동', '삼평동', '백현동', '금곡동', '구미1동', '구미동', '운중동'],
  yongin: ['포곡읍', '모현읍', '이동읍', '남사읍', '양지읍', '원삼면', '백암면', '중앙동', '역북동', '삼가동', '유림1동', '유림2동', '동부동', '신갈동', '영덕1동', '영덕2동', '구갈동', '상갈동', '보라동', '기흥동', '서농동', '구성동', '마북동', '동백1동', '동백2동', '동백3동', '상하동', '보정동', '풍덕천1동', '풍덕천2동', '신봉동', '죽전1동', '죽전2동', '죽전3동', '동천동', '상현1동', '상현2동', '상현3동', '성복동'],
  suwon: ['파장동', '율천동', '정자1동', '정자2동', '정자3동', '영화동', '송죽동', '조원1동', '조원2동', '연무동', '세류1동', '세류2동', '세류3동', '평동', '서둔동', '구운동', '금곡동', '호매실동', '권선1동', '권선2동', '곡선동', '입북동', '매교동', '매산동', '고등동', '화서1동', '화서2동', '지동', '우만1동', '우만2동', '인계동', '행궁동', '매탄1동', '매탄2동', '매탄3동', '매탄4동', '원천동', '영통1동', '영통2동', '영통3동', '망포1동', '망포2동', '광교1동', '광교2동'],
  osan: ['중앙동', '대원1동', '대원2동', '남촌동', '신장1동', '신장2동', '세마동', '초평동'],
  pyeongtaek: ['팽성읍', '안중읍', '포승읍', '청북읍', '진위면', '서탄면', '고덕면', '오성면', '현덕면', '중앙동', '서정동', '송탄동', '지산동', '송북동', '신장1동', '신장2동', '신평동', '원평동', '통복동', '비전1동', '비전2동', '용이동', '세교동', '동삭동', '고덕동'],
  anseong: ['공도읍', '보개면', '금광면', '서운면', '미양면', '대덕면', '양성면', '원곡면', '일죽면', '죽산면', '삼죽면', '고삼면', '안성1동', '안성2동', '안성3동'],
  hwaseong: ['우정읍', '향남읍', '남양읍', '마도면', '송산면', '서신면', '팔탄면', '장안면', '양감면', '새솔동', '봉담읍', '매송면', '비봉면', '정남면', '기배동', '진안동', '병점1동', '병점2동', '반월동', '화산동', '동탄1동', '동탄2동', '동탄3동', '동탄4동', '동탄5동', '동탄6동', '동탄7동', '동탄8동', '동탄9동'],
  ansan: ['일동', '이동', '사동', '사이동', '해양동', '본오1동', '본오2동', '본오3동', '부곡동', '월피동', '성포동', '반월동', '안산동', '와동', '고잔동', '중앙동', '호수동', '원곡동', '백운동', '신길동', '초지동', '선부1동', '선부2동', '선부3동', '대부동'],
  siheung: ['대야동', '신천동', '신현동', '은행동', '매화동', '목감동', '군자동', '월곶동', '정왕본동', '정왕1동', '정왕2동', '정왕3동', '정왕4동', '배곧1동', '배곧2동', '과림동', '연성동', '장곡동', '능곡동', '거북섬동'],
  gunpo: ['군포1동', '군포2동', '산본1동', '산본2동', '금정동', '재궁동', '오금동', '수리동', '궁내동', '대야동', '광정동', '송부동'],
  uiwang: ['고천동', '부곡동', '오전동', '내손1동', '내손2동', '청계동'],
  anyang: ['안양1동', '안양2동', '안양3동', '안양4동', '안양5동', '안양6동', '안양7동', '명학동', '병목안동', '석수1동', '석수2동', '충훈동', '박달동', '호현동', '비산1동', '비산2동', '비산3동', '부흥동', '달안동', '관양동', '인덕원동', '부림동', '평촌동', '평안동', '귀인동', '호계1동', '호계2동', '호계3동', '범계동', '신촌동', '갈산동'],
  gwacheon: ['중앙동', '원문동', '갈현동', '별양동', '부림동', '과천동', '문원동'],
  bupyeong: ['부평1동', '부평2동', '부평3동', '부평4동', '부평5동', '부평6동', '산곡1동', '산곡2동', '산곡3동', '산곡4동', '청천1동', '청천2동', '갈산1동', '갈산2동', '삼산1동', '삼산2동', '부개1동', '부개2동', '부개3동', '일신동', '십정1동', '십정2동'],
...
const DISTRICT_PLACES = {
  ...
  yeoncheon: [
    { name: '한탄강관광지 강변 산책로', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '전곡리유적 야외 산책로', act: '🚶 산책', env: 'urban' },
  ...
  pocheon: [
    ...
    { name: '고모호수공원 둘레길', act: '🚶 산책', env: 'riverside' },
  ...
  gapyeong: [
    ...
    { name: '북한강 자전거길 청평·가평 구간', act: '🚴 라이딩', env: 'riverside' },
  ...
  dongducheon: [
    ...
    { name: '소요산 입구·자재암 접근길', act: '🚶 산책', env: 'mountain' },
    { name: '소요 별앤숲 테마파크 산책로', act: '🚶 산책', env: 'mountain' },
    { name: '동두천자연휴양림 숲길', act: '🚶 산책', env: 'mountain' },
    { name: '시민평화공원', act: '🚶 산책', env: 'urban' },
  ],
  yangju: [
    { name: '옥정중앙공원', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '나리농원', act: '🚶 산책', env: 'urban' },
  ...
  paju: [
    ...
    { name: '공릉천 자전거길', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ...
  uijeongbu: [
    ...
    { name: '부용천 산책로·자전거길', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ...
  namyangju: [
    ...
    { name: '다산생태공원', act: '🚶 산책', env: 'riverside' },
  ...
  guri: [
    ...
    { name: '왕숙천 구리 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ...
  yangpyeong: [
    ...
    { name: '갈산공원', act: '🚶 산책·러닝', env: 'riverside' },
  ...
  yeoju: [
    ...
    { name: '당남리섬', act: '🚶 산책', env: 'riverside' },
  ...
  gwangju_gg: [
    ...
    { name: '경안천습지생태공원', act: '🚶 산책', env: 'riverside' },
  ...
  icheon: [
    ...
    { name: '복하천 제1·제2수변공원 일대', act: '🚶 산책·러닝', env: 'riverside' },
  ...
  hanam: [
    ...
    { name: '한강변 당정뜰·미사 자전거길', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ...
  seongnam: [
    ...
    { name: '분당중앙공원', act: '🚶 산책·러닝', env: 'urban' },
  ...
  yongin: [
    ...
    { name: '탄천 죽전·보정 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ...
  suwon: [
    ...
    { name: '만석공원', act: '🚶 산책·러닝', env: 'riverside' },
  ...
  osan: [
    ...
    { name: '맑음터공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '물향기수목원', act: '🚶 산책', env: 'mountain' },
    { name: '고인돌공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '독산성·세마대지', act: '🚶 산책', env: 'mountain' },
  ],
  pyeongtaek: [
    { name: '배다리생태공원', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '소풍정원', act: '🚶 산책', env: 'riverside' },
  ...
  anseong: [
    ...
    { name: '금광호수 박두진문학길', act: '🚶 산책', env: 'riverside' },
  ...
  hwaseong: [
    ...
    { name: '동탄센트럴파크', act: '🚶 산책·러닝·라이딩', env: 'urban' },
  ...
  ansan: [
    ...
    { name: '화랑유원지 호수 산책로', act: '🚶 산책·러닝', env: 'riverside' },
  ...
  siheung: [
    ...
    { name: '시흥 그린웨이 호조벌·관곡지 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ...
  gunpo: [
    ...
    { name: '반월호수공원', act: '🚶 산책', env: 'riverside' },
    { name: '철쭉동산·철쭉공원', act: '🚶 산책', env: 'urban' },
    { name: '수리산 임도오거리 접근길', act: '🚶 산책', env: 'mountain' },
    { name: '안양천 군포 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ],
  uiwang: [
    { name: '왕송호수·레솔레파크', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '백운호수 생태탐방로', act: '🚶 산책', env: 'riverside' },
    { name: '학의천 의왕 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
    { name: '바라산자연휴양림 숲길', act: '🚶 산책', env: 'mountain' },
    { name: '청계사 접근 숲길', act: '🚶 산책', env: 'mountain' },
  ],
  anyang: [
    { name: '안양천 쌍개울·석수 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
    { name: '학의천 안양 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
    { name: '평촌중앙공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '병목안시민공원', act: '🚶 산책', env: 'mountain' },
    { name: '안양예술공원', act: '🚶 산책', env: 'mountain' },
  ],
  gwacheon: [
    { name: '서울대공원 호수 주변 산책길', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '양재천 과천 구간', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
    { name: '과천중앙공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '관문체육공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '관악산 과천향교 계곡 입구', act: '🚶 산책', env: 'mountain' },
  ],
  bupyeong: [
    { name: '부평공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '굴포천 산책로', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '원적산공원', act: '🚶 산책', env: 'mountain' },
    { name: '신트리공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '부평나비공원', act: '🚶 산책', env: 'mountain' },
  ],
  michuhol: [
    { name: '수봉공원', act: '🚶 산책', env: 'mountain' },
    { name: '주인근린공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '승학체육공원', act: '🚶 산책', env: 'mountain' },
    { name: '용정근린공원', act: '🚶 산책·러닝', env: 'urban' },
    { name: '문학산 문학산성 접근길', act: '🚶 산책', env: 'mountain' },
  ],
  namdong: [
    { name: '인천대공원', act: '🚶 산책·러닝·라이딩', env: 'mountain' },
    { name: '소래습지생태공원', act: '🚶 산책', env: 'riverside' },
    { name: '장수천 산책로·자전거길', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
    { name: '늘솔길공원', act: '🚶 산책', env: 'mountain' },
    { name: '소래포구 해오름공원', act: '🚶 산책·러닝·라이딩', env: 'riverside' },
  ],
  yeonsu: [
    { name: '송도센트럴파크', act: '🚶 산책·러닝', env: 'riverside' },
    { name: '송도달빛축제공원', act: '🚶 산책·러닝', env: 'urban' },
