...
const DISTRICT_PLACES = {
  ...
  yeongdeungpo: [
    ...
    { name: '양화한강·양평', act: '🚴 라이딩', env: 'riverside' },
    { name: '안양천 합류', act: '🚴 라이딩', env: 'riverside' },
  ...
  seocho: [
    ...
    { name: '서리풀공원·몽마르뜨', act: '🚶 산책', env: 'mountain' },
  ...
  gangnam: [
    ...
    { name: '압구정·잠원 한강', act: '🚴 라이딩·러닝', env: 'riverside' },
  ...
  seongbuk: [
    ...
    { name: '북한산 정릉계곡', act: '🚶 산책', env: 'mountain' },
  ...
  jongno: [
    ...
    { name: '북촌·수성동계곡', act: '🚶 산책', env: 'urban' },
  ],
  jung: [
